        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider whitespace-nowrap w-[110px] shrink-0">Giới hạn độ bền</label>
            ...
            <div className="flex items-center gap-2">
              <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider whitespace-nowrap w-[110px] shrink-0">Module đàn hồi</label>
              <div className="relative flex-1 min-w-[110px]">
                <input
                  type="number"
