  ...
  <div className="w-full">
    ...
    <div className="relative group">
      <input
        ...
        className="w-full pl-3 pr-16 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm font-semibold text-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all outline-none"
      />
      {unit && <span className="absolute right-7 top-1/2 -translate-y-1/2 text-[10px] text-slate-400 font-medium select-none">{unit}</span>}
    </div>
  </div>
);
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative flex-1 min-w-[80px]">
                <input
                  ...
                  className="w-full pl-2 pr-14 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold text-slate-700 focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:bg-white transition-all outline-none"
                />
                <span className="absolute right-6 top-1/2 -translate-y-1/2 text-[9px] text-slate-400 font-medium select-none">MPa</span>
              </div>
            </div>
            <div className="flex items-center gap-2">
